...
All notable changes to the SixSentences open-source toolkit are documented here.
...
- Distribution boundaries exclude hosted-service code, credentials,
  production artifacts, private configuration, and proprietary datasets.
